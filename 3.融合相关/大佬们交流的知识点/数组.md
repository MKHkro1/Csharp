...
```C
/Namespace:public class TravelBuffOptionButton UIButton /TypeDefIndex:2395f/Fieldspublic Transform axis:/0x60public TextMeshProUGUI introduce:/0x68public TravelMgr manager:/0x70private Image background:/0x78public bool set:/0x80public BuffType buffType:/0x84public int buffIndex://0x88public GameObject show:/0x90/Methods/RVA:0x3DFOD0 Offset:0x3DE2D0 VA:0x1803DFOD0private void Awake(){}/RVA:0x3DFBF0 Offset:0x3DEDFO VA:0x1803DFBFO Slot:4protected override void Start({//RVA:0x3DF1A0 Offset:0x3DE3A0 VA:0x1803DF1A0 Slot:10public virtual void Clear({/RVA:0x3DF4A0 Offset:Ox3DE6A0 VA:0x1803DF4A0 Slot:11public virtual void SetBuff(BuffType buffType,int buffIndex,bool refresh False){}//RVA:0x3DF520 Offset:0x3DE720 VA:0x1803DF520private void SetPlant({/RVA:0x3DF890 Offset:0x3DEA90 VA:0x1803DF890private void SetPlant(PlantType thePlantType){}/RVA:0x3DFA80 Offset:0x3DEC80 VA:0x1803DFA80private void SetZombie(ZombieType theZombieType){}/RVA:0x3DF270 offset:0x3DE470 VA:0x1803DF270public void OnAnimOverO {//RVA:0x3DF290 Offset:0x3DE490 VA:0x1803DF290private void SetBackground(TravelBuffOptionButton.BgType bgType){}/RVA:0x317730 Offset:0x316930VA:0x180317730public void.ctor(){}
```
里面有个 setbuff
...
哦，也是直接改的数组
```C
//RVA:0x4A84D0 Offset:0x4A76D0 VA:0x1804A84D0public void UnlockPlantData(int choiceIndex){}/RVA:0x4A87B0 Offset:0x4A79B0 VA:0x1804A87B0public void UpgradeUltimatePlantData(int index,int level 1){}/RVA:0x4A6B10 Offset:0x4A5D10 VA:0x1804A6B10public void DebuffData(int index){}/RVA:0x4A85000 ffset:0x4A7700VA:0x1804A8500public void UpgradeAdvancedPlantData(int index){}
```
...
```C
case20://0x14//增加光照等级Board.Instance.AddLightLevel(4,false);break;case25://0x19//获得3000阳光Board.Instance.GetSun(3000,2,true,false);break;3//标记该升级已完成var advancedUpgrades this.advancedUpgrades;if (advancedUpgrades =null)ThrowNullReferenceException();if (index <0 index >advancedupgrades.Length)ThrowIndexOutofRangeException();advancedUpgrades[index]true;
```
因为这样
...
看看 PVZRHTools 呗
```C
var advs travelMgr.advancedUpgrades;for (var i=0;i<advs.Count;i++){advs[i]=AdvBuffs[i]advs[i];yield return null;}var ultis travelMgr.ultimateUpgrades;for (var i=0;i<ultis.Count;i++)Eultis[i]UltiBuffs[i]ultis[i]is 11 0;yield return null;}var deb travelMgr.debuff;for (var i=0;i<deb.Count;i++)fdeb[i]Debuffs[i]deb[i];yield return null;}
```
